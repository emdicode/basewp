...
function Image(el) {
  this.el = el;
  console.warn('Initialized `Image` module.');
}
    ...
    mount() {
      for (const type in types) {
        ...
        for (let i = 0; i < nodes.length; i++) {
          ...
          try {
            const instance = type === 'module' ? __webpack_require__("./modules sync recursive ^\\.\\/.*\\/.*\\.js$")(`./${name}/${name}.js`).default(nodes[i]) : __webpack_require__("./modules sync recursive ^\\.\\/.*\\.js$")(`./${name}.js`).default(nodes[i]);
